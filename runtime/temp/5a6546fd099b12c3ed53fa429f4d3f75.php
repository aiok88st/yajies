<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"F:\wamp\www\yajie/app/admin\view\distributor\list.html";i:1509532343;s:49:"F:\wamp\www\yajie/app/admin\view\common\head.html";i:1509507433;s:49:"F:\wamp\www\yajie/app/admin\view\common\foot.html";i:1507509539;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="admin-main layui-anim layui-anim-upbit">
    <fieldset class="layui-elem-field layui-field-title">
        <legend>经销商<?php echo lang('list'); ?></legend>
    </fieldset>
    <div class="demoTable">
        ...
        <a href="<?php echo url('lists'); ?>" class="layui-btn">显示全部</a>
        <button type="button" class="layui-btn layui-btn-danger" id="delAll">批量删除</button>
        <a href="<?php echo url('Distributor/add'); ?>?t=1" class="layui-btn" style="float:right;margin-right: 15px;"><?php echo lang('add'); ?></a>
...
<script type="text/html" id="action">
    <a href="<?php echo url('edit'); ?>?id={{d.id}}&t=1&pid={{d.pid}}" class="layui-btn layui-btn-mini">编辑</a>
