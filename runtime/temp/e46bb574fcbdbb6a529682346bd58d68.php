<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:51:"F:\wamp\www\yajie/app/admin\view\networks\edit.html";i:1509610974;s:49:"F:\wamp\www\yajie/app/admin\view\common\head.html";i:1509507433;s:49:"F:\wamp\www\yajie/app/admin\view\common\foot.html";i:1507509539;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    loadRegion('province',2,'city',"<?php echo url('getAddrs'); ?>","<?php echo $info['city']; ?>");
    setTimeout(function(){
        loadRegion('city',3,'area',"<?php echo url('getAddrs'); ?>","<?php echo $info['area']; ?>");
    },500);
