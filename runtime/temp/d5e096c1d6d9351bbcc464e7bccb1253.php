<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:55:"F:\wamp\www\yajie/app/admin\view\distributor\list2.html";i:1509532043;s:49:"F:\wamp\www\yajie/app/admin\view\common\head.html";i:1509507433;s:49:"F:\wamp\www\yajie/app/admin\view\common\foot.html";i:1507509539;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="admin-main layui-anim layui-anim-upbit">
    <fieldset class="layui-elem-field layui-field-title">
        <legend>分销商<?php echo lang('list'); ?></legend>
    </fieldset>
    <div class="demoTable">
        ...
        <a href="<?php echo url('list2'); ?>" class="layui-btn">显示全部</a>
        <button type="button" class="layui-btn layui-btn-danger" id="delAll">批量删除</button>
        <a href="<?php echo url('Distributor/add'); ?>?t=2" class="layui-btn" style="float:right;margin-right: 15px;"><?php echo lang('add'); ?></a>
...
<script type="text/html" id="action">
    <a href="<?php echo url('edit'); ?>?id={{d.id}}&t=2&pid={{d.pid}}" class="layui-btn layui-btn-mini">编辑</a>
    ...
    layui.use('table', function() {
        ...
        var tableIn = table.render({
            ...
            cols: [[
                ...
                {field: 'add_time', title: '<?php echo lang("add"); ?><?php echo lang("time"); ?>', width: 180},
        ...
        table.on('tool(list)', function(obj) {
            ...
            if(obj.event === 'open'){
                ...
                $.post('<?php echo url("adminState"); ?>',{'id': data.id},function (res) {
                    layer.close(loading);
                    if (res.status==1) {
                        if (res.open == 1) {
                            obj.update({
