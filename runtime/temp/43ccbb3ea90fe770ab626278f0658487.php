<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"F:\wamp\www\yajie/app/admin\view\distributor\edit.html";i:1509534660;s:49:"F:\wamp\www\yajie/app/admin\view\common\head.html";i:1509507433;s:49:"F:\wamp\www\yajie/app/admin\view\common\foot.html";i:1507509539;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="layui-form layui-form-pane">
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                ...
                <select name="pid" lay-verify="required"  >
                    ...
                    <option <?php if($pid == $vo['id']): ?>selected="selected"<?php endif; ?> value="<?php echo $vo['id']; ?>"><?php echo $vo['username']; ?></option>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                ...
                <?php else: ?>
                <a href="<?php echo url('list2'); ?>" class="layui-btn layui-btn-primary"><?php echo lang('back'); ?></a>
                <?php endif; ?>
            </div>
        </div>
    </form>
...
<script>
    ...
    m.controller('ctrl',['$scope',function($scope) {
        $scope.field = '<?php echo $info; ?>'!='null'?<?php echo $info; ?>:{pid:0,username:'',tel:''};
        console.log($scope.field);
        $scope.pid = <?php echo $p; ?>;
...
//            form.render();
            form.on('submit(submit)', function (data) {
                ...
                $.post("<?php echo url('Distributor/edit'); ?>", data.field, function (res) {
                    layer.close(loading);
                    if (res.code > 0) {
